...
class UserModel
{
     ...
     */
    public function addUser(string $name,string $firstname, string $gender, string $email, string $phone, string $school ,string $password, string $school, int $id_city, int $id_account): bool
    {
